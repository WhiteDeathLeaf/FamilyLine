...
public class RegexUtil {
    ...
    public static int verifyUsername(String username) {
        Precondition.checkNonNull(username, "verifyUsername: username is null");
    ...
    public static int verifyPassword(String password) {
        Precondition.checkNonNull(password, "verifyPassword: password is null!");
    ...
    public static int verifyNickname(String nickname) {
        Precondition.checkNonNull(nickname, "verifyUsername: username is null");
