...
import com.galaxy_light.gzh.familyline.custom.widget.LeBubbleTextView;
import com.galaxy_light.gzh.familyline.custom.widget.LeBubbleView;


/**
 * Created by dupengtao on 15/10/9.
 */
public class LeBubbleTextViewManager {
    ...
    public LeBubbleTextViewManager() {
    }

    public LeBubbleTextViewManager(LeBubbleView bubbleView) {
    ...
    /**
     * @return
     * @see LeBubbleTextViewManager#getBubbleView()
     */
    @Deprecated
